...
##### \qquad \qquad Treatment Total
Use <tt>rbind</tt> or <tt>bind_rows</tt> to duplicate the created data frame and use <tt>mutate</tt> or <tt>transform</tt> within <tt>rbind</tt> to assign <tt>trt01an = 3</tt>, which represents the treatment total.
